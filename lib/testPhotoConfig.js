...
// 証明の問題(2026-09-19に配布した中2限定の1回きりの問題)満点提出。
// 2026-09-26を過ぎたら提出画面自体を表示しない(client側でも同じ日付を見て隠す)。
const PROOF_TEST_MP = 500;
const PROOF_TEST_ALLOWED_GRADES = ['中2'];
const PROOF_TEST_DEADLINE = '2026-09-26';
const TEST_PHOTO_TYPES = ['pena', 'ranking', 'hyakuMasu', 'challenge', 'proof'];
