(function () {
  ...
  const SCIENCE_CATEGORIES = [
    ...
    { id: 'forceAction3', label: '力の作用・水中ではたらく力（中3）', gen: genForceAction3, addedDate: '2026-08-22', adminOnly: true },
    { id: 'energyWork3', label: 'エネルギーと仕事（中3）', gen: genEnergyWork3, addedDate: '2026-08-22', adminOnly: true },
    { id: 'energyConservation3', label: 'エネルギーの変換と保存（中3）', gen: genEnergyConservation3, addedDate: '2026-08-22', adminOnly: true },
